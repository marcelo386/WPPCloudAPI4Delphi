...
begin
  // bem simples; amplie conforme necessário
...
var
  ...
  begin
    // trate como transitório: rate limit ou falhas de servidor/gateway
...
begin
  ...
  LReq := TRequest.New
            ...
            .Accept(MimeType)                 // o que você espera receber
            .AddHeader('User-Agent',
                       'Mozilla/5.0 (Windows NT 10.0; Win64; x64) ' +
                       'AppleWebKit/537.36 (KHTML, like Gecko) ' +
                       'Chrome/120.0.0.0 Safari/537.36')
            .Timeout(TIMEOUT_MS)
            .RaiseExceptionOn500(False);      // não lançar exceção automática em 500+
  ...
  begin
    try
      ...
      begin
        // captura um trecho do corpo para ajudar no diagnóstico
        LBodyErr := Shorten(LResp.Content);
        // se for erro transitório, tenta de novo com backoff
      ...
      begin
        // alguns servidores só populam Content (string). Tente cair para Bytes.
      ...
      on E: Exception do
      begin
        // Se for a última tentativa, retorna o erro; senão, faz backoff
